		...
		return <div className="row main">
			...
			<div className="medium-10 large-10 columns">
				<ul className="inline-list same-height-child">
					...
					<li><LazyImage link={getSVGIcon('babel')} alt="React JS" /></li>
					<li><LazyImage link={getSVGIcon('webpack')} alt="Gulp JS" /></li>
...
const WhatImExperimentingWith = () => {
	return <div className="row main">
		<div className="medium-2 large-2 columns text-right"><h2>What I'm experimenting with</h2></div>
		<div className="medium-10 large-10 columns">
			<ul className="inline-list same-height-child">
				<li><LazyImage link={getSVGIcon('html')} alt="HTML5" /></li>
				<li><LazyImage link={getSVGIcon('sass')} alt="SASS" /></li>
