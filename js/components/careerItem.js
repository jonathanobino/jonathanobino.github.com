...
const PortfolioItem = React.createClass({
	render: function(){
		...
		let technology  = this.props.item.description.technology ? <p><span className="sans">Technology Involved</span> {this.props.item.description.technology}</p>:'';
		return (
				<div className="row careerItem">
					<div className="large-9 medium-8 small-10 columns description">
